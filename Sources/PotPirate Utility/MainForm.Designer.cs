...
namespace PotPirate_Utility
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
            ...
            this.button1.Text = "Использовать плеер для просмотра торрент-фильмов";
            ...
            this.label2.Text = "Жмакни по мне и узнаешь как смотреть торренты";
